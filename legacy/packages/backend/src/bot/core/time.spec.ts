...
describe("TrackmaniaTime.parse function", () => {
	...
	test("should pad milliseconds if less than 3 digits", () => {
		const time = TrackmaniaTime.parse("1:02:03.4");
