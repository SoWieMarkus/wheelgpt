  ...
  public readonly commands = signal<Command[]>([
    {
      ...
      example: [
        { isBot: false, text: "!guess 1:23.456" },
      ],
      accessLevel: "User",
    },
    {
    ...
    },
    {
      ...
      example: [
        ...
        { isBot: true, text: "NEW PERSONAL BEST 1:23.457 $$DINK_DONK$$ That's $$AUTHOR_MEDAL$$ $$OK$$ Nobody guessed it correctly but @sowiemarkus guessed 1:23.456 (- 0.001) $$OK$$" },
      ],
      accessLevel: "Mod",
    },
    {
